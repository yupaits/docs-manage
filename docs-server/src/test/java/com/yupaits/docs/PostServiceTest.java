...
public class PostServiceTest {
    ...
    public void test01AddPostCates() {
        postCateRepository.save(new PostCate("Java"));
        postCateRepository.save(new PostCate("Spring Cloud"));
    }

    @Test
    public void test02AddPost() {
        Long cateId = postCateRepository.findAll().get(0).getId();
        postService.addPost(new PostCreate("Java基础", "Java集合类；Java反射", cateId, true, Lists.newArrayList("Java", "集合")));
    ...
    public void test03UpdatePost() {
        ...
        postUpdate.setTags(Lists.newArrayList("Java", "反射"));
    ...
    public void test04DeletePost() {
        ...
        postTagRepository.delete(postTagRepository.findAllByPostId(post.getId()));
