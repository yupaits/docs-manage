 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.yupaits.docs.repository", "com.yupaits.auth.repository"})
@EntityScan(basePackages = {"com.yupaits.docs.entity", "com.yupaits.auth.entity"})
